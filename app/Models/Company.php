...
class Company extends Model implements HasMedia
{
    ...
    public $fillable = [
        ...
        'unique_id',
        'last_change',
        'billing_name','billing_address','billing_municipio','billing_provincia','billing_postal_code','billing_dni'
    ];
    ...
    public static $rules = [
        ...
        'details'           => 'nullable',
        'location'          => 'required',
        'no_of_offices'     => 'nullable|numeric|min:1|max:1000',
        'country_id'        => 'required',
        'state_id'          => 'nullable',
        'city_id'           => 'nullable',
    ];
    ...
    public function getCompanyUrlAttribute()
    {
        ...
        return asset('assets/img/profile-icon.png');
    }
