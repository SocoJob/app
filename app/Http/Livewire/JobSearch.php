...
class JobSearch extends Component
{
    ...
    public function searchJobs()
    {
        ...
        $query->when(! empty($this->searchLocation), function (Builder $q) {
            $q->where(function (Builder $q) {
                // $q->where('job_title', 'like', '%'.$this->searchLocation.'%');
                $q->whereHas(
                    'country',
                    function (Builder $q) {
        ...
        $query->when(! empty($this->searchByLocation), function (Builder $q) {
            $q->where(function (Builder $q) {
                ...
                function (Builder $q) {
                    $q->where('shift', 'like', '%'.$this->searchByLocation.'%');
                }
            );
            });
        });
