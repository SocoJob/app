...
class CompanyTable extends LivewireTableComponent
{
        ...
        return [
            ...
            Column::make(__('Verificado'), 'user.is_verified')
                ->format(function ($value, $row) {
                    return view('companies.table_components.is_verified', ['companyId' => $row->id, 'isVerified' => $value]);
                }),
    ...
    public function toggleVerification($companyId, $newValue)
    {
        $candidate = Company::findOrFail($companyId);
