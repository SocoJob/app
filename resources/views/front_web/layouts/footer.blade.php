...
<footer class="footer bg-light">
    <div class="container-fluid">
        <div class="row mx-1">
            <div class="col-12 col-sm-6 col-lg-3">
                ...
                <div class="social-icon d-flex my-4" style="margin-left: -5px;">
                    @if(!empty($settings['facebook_url']))
                        <a href="{{ $settings['facebook_url'] }}" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-3">
                            <img src="{{ asset('images/facebook.png') }}" alt="">
                        </a>
                    @endif
                    @if(!empty($settings['twitter_url']))
                        <a href="{{ $settings['twitter_url'] }}" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-3">
                            <img src="{{ asset('images/twitter.png') }}" alt="">
                        </a>
                    @endif
                    @if(!empty($settings['google_plus_url']))
                        <a href="{{ $settings['google_plus_url'] }}" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-3">
                            <img src="{{ asset('images/instagram.png') }}" alt="">
                        </a>
                    @endif
                    @if(!empty($settings['linkedIn_url']))
                        <a href="{{ $settings['linkedIn_url'] }}" target="_blank" class="social-icon-box d-flex align-items-center justify-content-center me-3">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <h3 class="mb-3 text-secondary fs-18 fw-bold" style="font-size: 0.8em !important;line-height: 1;font-weight: 600 !important;letter-spacing: 2px;">{{ __('web.footer.noticies') }}</h3>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <h3 class="mb-2 text-secondary fs-18 fw-bold" style="font-size: 0.8em !important;line-height: 1;font-weight: 600 !important;letter-spacing: 2px;">{{__('web.footer.download_app')}}</h3>
                <div class="row px-0 mb-3">
                    <div class="col mt-2">
                        <a href="#"> <img src="{{ asset('images/app1.png') }}" alt="" style="width: 10rem;"></a>
                       
                    </div>
                    <div class="col mt-2">
                        <a href="#"> <img src="{{ asset('images/gp1.png') }}" alt="" style="    width: 10rem;"></a>
                       
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-lg-3">
                <h3 class="mb-3 text-secondary fs-18 fw-bold" style="font-size: 0.8em !important;line-height: 1;font-weight: 600 !important;letter-spacing: 2px;">{{__('web.footer.contact_us')}}</h3>
                <div class="footer-info">
                    ...
                    <div class="d-flex footer-info__block mb-3 justify-content-start">
                        <a href="{{ route('front.search.jobs') }}" class="btn btn-primary btn-lg text-white" style="font-size: inherit;border-radius: 8px;padding: 0.5rem 2rem;background-color: #026295;font-family: 'Poppins';">Ofertas de trabajo</a>
                    </div>
        ...
        <div class="row pt-5">
            <div class="col-8 mx-auto text-center">
                ...
                <p style="font-size: 0.7em;text-transform: uppercase;letter-spacing: 0.14em;font-weight: 700;color: rgba(34, 34, 34, 0.5);fill: rgba(34, 34, 34, 0.5);padding-bottom: 4em;">©COPYRIGHT {{ date('Y') }} | TODOS LOS DERECHOS RESERVADOS </p>
            </div>
