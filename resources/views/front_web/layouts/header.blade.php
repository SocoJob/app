    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-3 col-4">
                <a href="{{ route('front.search.jobs') }}" class="header-logo">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <ul class="navbar-nav align-items-center py-2 py-lg-0">
                            <!-- <li class="nav-item">
                                <a class="nav-link {{ Request::is('/') ? 'active' : '' }}" aria-current="page"
                                   href="https://socojob.com/{{-- route('front.home') --}}">{{ __('web.home') }}</a>
                            </li> -->
                            <li class="nav-item">
                            ...
                            <!-- <li class="nav-item">
                                <a class="nav-link {{ Request::is('about-us') ? 'active' : '' }}"
                                   href="https://socojob.com/nosotros/">Nosotros {{-- route('front.about.us') --}}{{-- __('web.about_us') --}}</a>
                            </li> -->
                            <!-- <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('posts*') ? 'active' : '' }}"
                                   href="https://socojob.com/blog/">Blog{{-- route('front.post.lists') }}">{{ __('messages.post.blog') --}}</a>
                            </li> -->
                            {{--
                            <li class="nav-item">
                                                ...
                                                @if(checkLanguageSession() != $key)
                                                    <li class="nav-item">
                                                        <a href="javascript:void(0)"
                                                           class="nav-link d-flex align-items-center languageSelection"
                        ...
                        @if(!Auth::check())
                            <div class="text-lg-end header-btn-grp ms-lg-3">
                                <ul class="navbar-nav align-items-center py-2 py-lg-0">
                                    <li class="nav-item">
                                        <a href="{{route('front.candidate.login')}}" class="nav-link me-xxl-3 me-2 mb-3 mb-lg-0 nav-link">{{ __('web.login') }}</a>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('candidate.register')}}" class="mb-3 mb-lg-0 nav-link">{{ __('web.register') }}</a>
                                        <ul class="nav submenu">
                                            <li class="nav-item">
                                ...
                                <ul class="navbar-nav align-items-center py-2 py-lg-0">
                                    <li class="nav-item">
                                        <a href="javascript:void(0)" class="mb-3 mb-lg-0 user-logo d-flex align-items-center" >
                                            ...
                                            <span class="text-truncate text-primary"> {{ __('messages.common.hi') }}, {{getLoggedInUser()->full_name}}</span>
                                        </a>
                                        <ul class="nav submenu">
                                            <li class="nav-item">
