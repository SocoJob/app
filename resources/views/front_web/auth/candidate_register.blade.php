                    ...
                    <div class="col-xl-6 col-lg-8 mx-auto">
                        ...
                        <form method="POST" id="addCandidateNewForm"
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control fs-14 text-gray br-10" name="first_name"
                                               id="candidateFirstName" placeholder="Nombre"
                                               required>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control fs-14 text-gray br-10" name="last_name"
                                               id="candidateLastName" placeholder="Apellido"
                                               required>
                                    </div>
                                </div>
                                <div class="col-md-12 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control fs-14 text-gray br-10" name="email"
                                               id="candidateEmail" placeholder="Correo electrónico"
                                               required>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                            ...
                            <div class="col-12 d-grid my-4">
                                <button type="submit" class="btn btn-primary" id="btnCandidateSave" data-loading-text="<span class='spinner-border spinner-border-sm'></span> {{__('messages.common.process')}}">
