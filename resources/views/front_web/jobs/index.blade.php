                    ...
                    <div class="hero-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb  justify-content-center mb-0">
                                <li class="breadcrumb-item "><a href="https://socojob.com/" class="fs-18 text-gray">@lang('web.home')</a>
                                </li>
    ...
    <section class="latest-job-section py-60">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="latest-job-left br-10 px-40 bg-gray">
                        <div class="form-group mb-md-4 mb-3 ">
                            ...
                            <!-- <input type="text" class="form-control fs-14 text-gray bg-white br-10 p-3" name="listing-search" id="searchByLocation" placeholder="@lang('web.web_home.job_title_keywords_company')"> -->
                        </div>


                        <div class="form-group mb-4 mb-3">
                            <label for="" class="fs-16 text-secondary mb-3">{{ __('messages.job.location') }}</label>
                            <input type="text" class="form-control fs-14 text-gray bg-white br-10 p-3" id="searchLocation" placeholder="Buscar por ubicación">
                        </div>
                        <div class="form-group mb-md-4 mb-3 ">
                                <label for="" class="fs-16 text-secondary mb-3">Tipo de contrato</label>
                        ...
                        <div class="">
                            <div class="form-group mb-md-4 mb-3 ">
                                <label for="" class="fs-16 text-secondary mb-3">Tipo de categoría</label>
                                @if($careerLevels->isNotEmpty())
                                    <select class="form-select fs-14 text-gray bg-white br-10 p-3" aria-label="None" data-live-search="true" data-size="5" name="search-career-level" id="searchCareerLevel">
                                        <option value="">@lang('web.job_menu.none')</option>
                            ...
                            <div class="form-group mb-md-4 mb-3 ">
                                <label for="" class="fs-16 text-secondary mb-3">Tipo de jornada</label>
                                @if($functionalAreas->isNotEmpty())
                                <select class="form-select fs-14 text-gray bg-white br-10 p-3" aria-label="None" data-live-search="true" data-size="5" name="search-functional-area" id="searchFunctionalArea">
                                    <option value="">@lang('web.job_menu.none')</option>
                            ...
                            <div class="form-group mb-md-4 mb-3 d-none">
                                ...
                                <select name="job-type" class="form-control jobType" multiple>
                ...
                <!-- <div class="job-img mt-5 mb-40 h-auto d-none">
