    ...
    <div class="apply-job-page">
        ...
        <section class="apply-job-section contact-section py-100">
            <div class="container">
                <div class="upper-box">
                    <div class="row">
                        <div class="col-xl-8 col-md-10 mx-auto mb-4 d-none">
                            <div class="row mb-3">
                                <div class="col-lg-2">
                ...
                <div class="col-xl-8 col-md-10 mx-auto">
                    <form id="applyJobForm" class="py-40 px-40 bg-gray">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 d-none">
                                <div class="response"></div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12 form-group chosen-search d-none">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 form-group d-none">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group d-none">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group text-center">
                                @if(!$isApplied)
                                    ...
                                    @if($isActive && !$job->is_suspended)
                                        <button class="btn btn-primary px-5 mx-2 apply-job"
                                                data-loading-text="<span class='spinner-border spinner-border-sm'></span> {{__('messages.common.process')}}"
                                                id="applyJobSave">{{ __('web.common.apply') }}</button>
                                    @endif
                                @else
                                    <button class="theme-btn btn-style-eight btn-primary">{{ __('web.apply_for_job.already_applied') }}</button>
                                @endif
                            </div>
                        </div>
                    </form>
