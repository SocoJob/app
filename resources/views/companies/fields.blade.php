<div class="row">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        ...
        <span class="required"></span>
        {{ Form::text('ceo', null, ['class' => 'form-control', 'placeholder' => __('messages.company.ceo_name')]) }}
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        ...
        <div class="input-group flex-nowrap">
            {{ Form::select('industry_id', $data['industries'], null, ['id'=>'addEmployerIndustryId','class' => 'form-select','placeholder' => __('messages.company.select_industry')]) }}
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        ...
        <span class="required"></span>
        <div class="input-group flex-nowrap">
            {{ Form::select('company_size_id', $data['companySize'], null, ['id'=>'companySizeId','class' => 'form-select','placeholder' => __('messages.company.select_employer_size')]) }}
            <div class="input-group-text border-0">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <span class="required"></span>
        {{ Form::selectYear('established_in', date('Y'), 1990, (isset($company->established_in)) ? $company->established_in : '', ['class' => 'form-select', 'id' => 'establishedIn','placeholder'=> __('messages.company.select_established_year'),'required']) }}
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        ...
        <span class="required"></span>
        {{ Form::text('no_of_offices', 1, ['class' => 'form-control', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'placeholder' => __('messages.company.no_of_offices')]) }}
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="d-block">
            <div class="image-picker">
                <div class="image previewImage" id="logoPreview"
                     style="background-image: url({{ asset('assets/img/profile-icon.png') }})">
                </div>
