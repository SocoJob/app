...
<div class="col-sm-6 d-flex flex-column mb-md-10 mb-5 d-none">
...
<div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="input-group">
            {{ Form::text('billing_name', isset($company->billing_name) ? $company->billing_name : null, ['class' => 'form-control','id'=>'billing_name','placeholder'=>'Razón Social','readonly']) }}
        </div>
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        {{ Form::label('billing_address', __('messages.company.billing_address').':', ['class' => 'form-label']) }}
        <div class="input-group">
            {{ Form::text('billing_address', isset($company->billing_address) ? $company->billing_address : null, ['class' => 'form-control','id'=>'billing_name','placeholder'=>'Dirección de Facturación','readonly']) }}
        </div>
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        {{ Form::label('billing_municipio', __('messages.company.billing_municipio').':', ['class' => 'form-label']) }}
        <div class="input-group">
            {{ Form::text('billing_municipio', isset($company->billing_municipio) ? $company->billing_municipio : null, ['class' => 'form-control','id'=>'billing_municipio','placeholder'=>'Municipio','readonly']) }}
        </div>
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        {{ Form::label('billing_provincia', __('messages.company.billing_provincia').':', ['class' => 'form-label']) }}
        <div class="input-group">
            {{ Form::text('billing_provincia', isset($company->billing_provincia) ? $company->billing_provincia : null, ['class' => 'form-control','id'=>'billing_provincia','placeholder'=>'Provincia','readonly']) }}
        </div>
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        {{ Form::label('billing_postal_code', __('messages.company.billing_postal_code').':', ['class' => 'form-label']) }}
        <div class="input-group">
            {{ Form::text('billing_postal_code', isset($company->billing_postal_code) ? $company->billing_postal_code : null, ['class' => 'form-control','id'=>'billing_postal_code','placeholder'=>'Código Postal','readonly']) }}
        </div>
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        {{ Form::label('billing_dni', __('messages.company.billing_dni').':', ['class' => 'form-label']) }}
        <div class="input-group">
            {{ Form::text('billing_dni', isset($company->billing_dni) ? $company->billing_dni : null, ['class' => 'form-control','id'=>'billing_dni','placeholder'=>'CIC/NIF/DNI/NIE','readonly']) }}
        </div>
    </div>
<div class="form-group col-sm-12 col-md-12 col-xl-6">
    ...
    <div class="image image-lg-small">
        <img id='logoPreview' class="testimonial-modal-img"
             src="{{ (!empty($company->user->media[0])) ? $company->user->media[0]->getFullUrl() : asset('assets/img/profile-icon.png') }}">
    </div>
    </div>
