<div class="row">
    ...
    <!-- <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        ...
        <span class="required"></span>
        {{ Form::text('ceo', (isset($company) ? $company->ceo: null), ['class' => 'form-control', 'placeholder' => __('messages.company.ceo_name')]) }}
    </div> -->
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        {{ Form::label('industry_id', __('messages.company.industry').':', ['class' => 'form-label']) }}
        <span class="required"></span>
        <div class="input-group flex-nowrap">
            {{ Form::select('industry_id', $data['industries'],isset($company)?$company->industry_id:null, ['id'=>'industryId','class' => 'form-select ','placeholder' => __('messages.company.select_industry')]) }}
            <div class="input-group-text border-0">
                <a href="javascript:void(0)" class="text-gray-500 createEmployerIndustryModal"><i class="fa fa-plus"></i></a>
            </div>
        </div>
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <span class="required"></span>
        <div class="input-group flex-nowrap">
            {{ Form::select('ownership_type_id', $data['ownerShipTypes'],  isset($company)?$company->ownership_type_id:null, ['id'=>'ownershipTypeId','class' => 'form-select ','placeholder' => __('messages.company.select_ownership_type')]) }}
            <div class="input-group-text border-0">
                <a href="javascript:void(0)" class="text-gray-500 createEmployerOwnerShipTypeModal"><i class="fa fa-plus"></i></a>
            </div>
        </div>
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="input-group flex-nowrap select2-width-input-grp">
            ...
            <div class="input-group-text border-0">
                <a href="javascript:void(0)" class="text-gray-500 createEmployerCountryModal"><i class="fa fa-plus"></i></a>
            </div>
        </div>
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="input-group flex-nowrap select2-width-input-grp">
            ...
            <div class="input-group-text border-0">
                <a href="javascript:void(0)" class="text-gray-500 createEmployerStateModal"><i class="fa fa-plus"></i></a>
            </div>
        </div>
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="input-group flex-nowrap">
            ...
            <div class="input-group-text border-0">
                <a href="javascript:void(0)" class="text-gray-500 createEmployerCityModal"><i class="fa fa-plus"></i></a>
            </div>
        </div>
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        ...
        <span class="required"></span>
        <div class="input-group flex-nowrap">
            {{ Form::select('company_size_id', $data['companySize'], isset($company)?$company->company_size_id:0, ['id'=>'companySizeId','class' => 'form-select ','placeholder' => __('messages.company.select_employer_size')]) }}
            <div class="input-group-text border-0">
                <a href="javascript:void(0)" class="text-gray-500 createEmployerCompanySizeModal"><i class="fa fa-plus"></i></a>
            </div>
        </div>
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="form-check form-switch mb-3">
            <input class="form-check-input isActive" name="is_active" type="checkbox" data-id="{{ $company->id }}" role="switch" id="active" value="1" {{  isset($company)?($company->user->is_active == 1 ?'checked':''):'checked' }}>
        </div>
    </div>
    <!-- Submit Field-->
    <div class="d-flex justify-content-end">
        {{ Form::submit(__('messages.common.save'),['class' => 'btn btn-primary me-3', 'id' => 'btnSave']) }}
        <a href="{{ route('company.index') }}" class="btn btn-secondary me-2">{{__('messages.common.cancel')}}</a>
    </div>
    <script>
