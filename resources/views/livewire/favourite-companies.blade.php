            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="row mb-2 justify-content-end">
                        <div class="col-md-3">
                            <input wire:model.debounce.100ms="searchByFavouriteCompanies" type="search" id="searchByFavouriteCompanies" placeholder="{{ __('web.job_menu.search_followings') }}" class="form-control search-box-placeholder">
                        </div>
                    </div>
                    @endif
                        ...
                        <div class="row  position-relative">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-xl-4 favorite-job-details mb-5">
                                <div class="hover-effect-favorite-company min-height-200 position-relative {{ $loop->odd ? 'blue-color' : 'black-color' }}">
                                    ...
                                    <div class="job-listing-details nopadding">
                                        <div class="d-flex job-listing-description ">
                                            <div class="pl-0 mb-auto float-left favourite-companies-avatar">
                                                <img src="{{ $favouriteCompany->company->user->avatar }}" class="img-responsive favorite-company-image mr-2">
                                            </div>
                                            <div class="mb-auto w-100 favorite-company-data favourite-companies-data">
                                                ...
                                                <h3 class="job-listing-title-favorite-company margin-bottom-5">
                                                    ...
                                                    <span data-toggle="tooltip" data-placement="bottom" title="{{$favouriteCompany->company->user->email}}">
                                    ...
                                    <a title="Delete" class="btn btn-danger action-btn delete-btn favorite-companies-delete" data-id="{{$favouriteCompany->id}}" href="#">
