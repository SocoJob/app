        ...
        <tr>
            <td>
                <table width="100%">
                    <tr>
                        <td>
                            <img style="text-align: center;" src='{{ $message->embed(getLogoUrl()) }}'
                                 alt="company logo"
                    ...
                    <tr>
                        <td>
                            <p style="margin-bottom: 0;text-align: center; font-size: 13px;">
                                <strong>&copy;  {{ date('Y') }} <a href="{{ route('front.search.jobs') }}" class="company-name" style="margin-top: -5px !important;">{{ getAppName() }}</a> .All rights reserved.</strong>
