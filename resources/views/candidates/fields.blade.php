<div class="row">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        ...
        <span class="required"></span>
        {{ Form::password('password', ['class' => 'form-control ','min' => '6','max' => '10', 'placeholder' => __('messages.candidate.password')]) }}
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        {{ Form::label('password_confirmation',__('messages.candidate.conform_password').':', ['class' => 'form-label ']) }}
        <span class="required"></span>
        {{ Form::password('password_confirmation', ['class' => 'form-control ','min' => '6','max' => '10', 'placeholder' => __('messages.candidate.conform_password')]) }}
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
   ...
   <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="input-group flex-nowrap">
            {{Form::select('candidateSkills[]',$data['skills'], null, ['class' => 'form-select custom-select2','id'=>'skillId','multiple'=>true])}}
    ...
    <!-- <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="input-group flex-nowrap">
            ...
            <div class="input-group-text border-0">
                <a href="javascript:void(0)" class="text-gray-500 createCandidateMaritalStatusModal"><i  class="fa fa-plus"></i></a>
            </div>
        </div>
    </div> -->
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 ">
        {{ Form::label('nationality', 'Nacionalidad española'.':', ['class' => 'form-label']) }}
        <select class="form-select" name="nationality" placeholder="Nacionalidad española">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <span class="required"></span>
        <div class="input-group flex-nowrap">
            {{ Form::select('country_id', $data['countries'], null, ['id'=>'countryId','class' => 'form-select ','required','placeholder' => __('messages.company.select_country')]) }}
            <div class="input-group-text border-0">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="input-group flex-nowrap">
            ...
            <div class="input-group-text border-0">
                <a href="javascript:void(0)" class="text-gray-500 createCandidateStateModal"><i class="fa fa-plus"></i></a>
            </div>
        </div>
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 mb-0 pt-1 d-none">
