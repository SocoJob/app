...
@section('content')
    ...
    <div class="row justify-content-center">
                    ...
                    <div class="card-body px-xl-10 px-7 py-xl-14 py-10 d-flex flex-column">
                        ...
                        <div class="d-flex justify-content-center mt-5">
                            <h4 class="text-center mb-6 mt-2">
                                ...
                                <span class="h6 text-gray-800 ml-2">Por @if($plan->interval == 'year') Año @else Mes @endif</span>
                            </h4>
                        </div>
                        @if(isset($subscription) && $subscription->plan_id == $plan->id)
                            ...
                            @endif
                        @endif
                        <ul class="pricing-plan-features text-gray-600 fs-4 mb-9 text-start ms-5">
                        
                            <li> <i class="fa-solid fa-check me-3"></i> Primer mes gratuito</li>
                            <li> <i class="fa-solid fa-check me-3"></i> Buscar socorristas</li>
                            <li> <i class="fa-solid fa-check me-3"></i> Publica ofertas de trabajo</li>
                            <li> <i class="fa-solid fa-check me-3"></i> Recibe candidaturas</li>
                            <li> <i class="fa-solid fa-check me-3"></i> Contacta con socorristas <span class="text-danger">*</span></li>
                            <!-- <li>
                        ...
                        @else
                            ...
                            @else
                                @if($activePlanId !== $plan->id)
                                    <a href="{{ route('payment-method-screen', $plan->id) }}"
                                       data-id="{{ $plan->id }}"
                                       class="btn btn-primary pricing-plan-btn mt-auto align-self-center"> {{ __('messages.plan.purchase') }}</a>
                                @endif
                            @endif
                        @endif
                    </div>
        ...
        @endforeach
        <div class="col-8 mx-auto" style="font-size:12px">
           
            <p class="text-muted"> <span class="text-danger">*</span>El precio por contactar con un socorrista a través de SocoJob es de 2€ (de septiembre a mayo) y de 4€ (de junio a agosto) </p>
