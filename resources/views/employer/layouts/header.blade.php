...
<header class='container-fluid container-xxl d-flex align-items-stretch justify-content-between'>
    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
        <a href="{{ route('front.search.jobs') }}" data-turbo="false"
           class="text-decoration-none horizontal-sidebar-logo d-flex align-items-center pe-xl-8">
            <div class="image image-mini me-3 ">
                <img src="{{getLogoUrl()}}" class="img-fluid w-100 d-none d-sm-block" alt="profile image" style="height: 3rem;">
                <img src="{{getLogoUrl()}}" class="img-fluid w-100 d-block d-sm-none" alt="profile image" style="height: 2rem;">
            </div>
