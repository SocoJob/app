<div class="row">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        ...
        <span class="required"></span>
        {{Form::select('jobsSkill[]',$data['jobSkill'], null, ['class' => 'form-select','data-control'=>'select2','id'=>'SkillId','multiple'=>true])}}
    </div>
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        ...
        <span class="required"></span>
        {{ Form::select('salary_period_id', $data['salaryPeriods'], null, ['id'=>'salaryPeriodsId','class' => 'form-select','data-control'=>'select2','placeholder' => 'Select Salary Period']) }}
    </div>
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="accommodation" value="si" @if($accommodation == 'si') checked @endif>
            <label class="form-check-label" for="">Si</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="accommodation" value="no" @if($accommodation == 'no') checked @endif>
    ...
    <div class="d-flex justify-content-end mt-5">
        {{ Form::button('Publicar', ['type' => 'submit','class' => 'btn btn-primary me-3','id' => 'editJobsSaveBtn','data-loading-text' => "<span class='spinner-border spinner-border-sm'></span> ".__('messages.common.process')]) }}
