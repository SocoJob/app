<div class="row">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        ...
        <span class="required"></span>
        {{Form::select('jobsSkill[]',$data['jobSkill'], null, ['class' => 'form-select','id'=>'SkillId','multiple'=>true,'data-control'=>'select2'])}}
    </div>
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        ...
        <span class="required"></span>
        {{ Form::select('salary_period_id', $data['salaryPeriods'], null, ['id'=>'salaryPeriodsId','class' => 'form-select','placeholder' => __('messages.company.select_salary_period'),'data-control'=>'select2']) }}
    </div>
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none" id="div_states">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none" id="div_cities">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        ...
        <span class="required"></span>
        {{ Form::select('functional_area_id', $data['functionalArea'], null, ['id'=>'functionalAreaId','class' => 'form-select','placeholder' => __('messages.company.select_functional_area'),'data-control'=>'select2']) }}
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        {{ Form::label('position', __('messages.job.position').':', ['class' => 'form-label']) }}
        <span class="required"></span>
        {{ Form::text('position',  null, ['id'=>'positionId','class' => 'form-control','placeholder' => 'Select Position', 'min' => 0, 'max' => 255, 'placeholder' => __('messages.job.position'), 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        {{ Form::label('experience', __('messages.job_experience.job_experience').':', ['class' => 'form-label']) }}
        <span class="required"></span>
        {{ Form::text('experience',  null, ['id'=>'experienceId','class' => 'form-control','placeholder' => 'Enter experience In Year', 'min' => 0, 'max' => 255, 'placeholder' => __('messages.job_experience.job_experience'), 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
    </div>
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        <label for="" class="form-label">Alojamiento</label><br>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="accommodation" value="si">
            <label class="form-check-label" for="">Sí</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="accommodation" value="no" checked>
            <label class="form-check-label" for="">No</label>
          </div>
    </div>
    <div class="col-xl-3 col-md-3 col-sm-12 mb-5 d-none">
    ...
    <div class="d-flex justify-content-end mt-5">
        ...
        {{ Form::button('Publicar', ['type' => 'submit', 'name' => 'save', 'class' => 'btn btn-primary me-3','id' => 'jobsSaveBtn','data-loading-text' => "<span class='spinner-border spinner-border-sm'></span> ".__('messages.common.process')]) }}
