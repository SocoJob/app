<div class="row">
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5">
        {{ Form::label('company_id', 'Nombre de empresa:', ['class' => 'form-label']) }}<span
                class="required"></span>
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 ">
        {{ Form::label('job_type_id','Tipo de contrato:', ['class' => 'form-label']) }}<span
                class="required"></span>
        <div class="input-group flex-nowrap">
            {{ Form::select('job_type_id', $data['jobType'],null, ['id'=>'jobTypeId','class' => 'form-select','placeholder' => __('messages.company.select_job_type'), 'data-control'=>'select2']) }}
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 custom-datepicker d-none">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 ">
        {{ Form::label('job_shift_id','Tipo de jornada:', ['class' => 'form-label ']) }}
        <div class="input-group flex-nowrap">
    ...
    <div class="col-xl-6 col-md-6 col-sm-12 mb-5 d-none">
        {{ Form::label('degree_level_id','Tipo de jornada', ['class' => 'form-label ']) }}
        <div class="input-group flex-nowrap">
            {{ Form::select('degree_level_id', $data['requiredDegreeLevel'], null, ['id'=>'requiredDegreeLevelId','class' => 'form-select','placeholder' => 'Seleccionar tipo de jornada', 'data-control'=>'select2']) }}
            <div class="input-group-text border-0">
