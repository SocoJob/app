            ...
            <div class="flex-grow-1">
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex my-4">
                        ...
                        <a href="{{ route('front.search.jobs') }}" class="btn btn-sm btn-info me-2">Buscar ofertas</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row g-5 g-xl-8">
    ...
    <div class="col-xxl-4 col-xl-4 col-sm-6 widget">
        <div class="shadow-md rounded-10 p-xxl-10 px-5 py-10 d-flex align-items-center justify-content-between my-sm-3 my-2" style="background-color:#5799CD !important">
            <div class="widget-icon rounded-10 me-2 d-flex align-items-center justify-content-center"  >
