...
//    Route::post('/read-all-notification', [NotificationController::class, 'readAllNotification'])->name('read-all-notification');
    ...
    Route::get('resumen/{id}/approve',[CandidateController::class, 'approve'])->name('admin.resumen.approve');
    Route::get('resumen/{id}/decline',[CandidateController::class, 'decline'])->name('admin.resumen.decline');
...
Route::group(['middleware' => ['auth', 'role:Employer', 'xss', 'verify.company'], 'prefix' => 'employer'], function () {
...
//    Route::post('/read-all-notification', [NotificationController::class, 'readAllNotification'])->name('read-all-notification');
    ...
    Route::get('employer-profile', [EmployerController::class, 'editProfile'])->name('employer-edit-profile')->withoutMiddleware(['verify.candidate']);
    Route::post('employer-change-password', [EmployerController::class, 'changePassword'])->name('employer-change-password')->withoutMiddleware(['verify.candidate']);
    Route::post('employer-profile-update', [EmployerController::class, 'profileUpdate'])->name('employer-profile-update')->withoutMiddleware(['verify.candidate']);
...
//    Route::post('job-applications/get-job-stage/{Id}', [JobApplicationController::class, 'getJobStage'])->name('get.job.stage');
    ...
    Route::get('{company}/edit', [CompanyController::class, 'editCompany'])->name('company.edit.form')->withoutMiddleware(['verify.company']);
    Route::put('{company}', [CompanyController::class, 'updateCompany'])->name('company.update.form')->withoutMiddleware(['verify.company']);
...
Route::group(['namespace' => 'Web', 'middleware' => ['xss', 'setLanguage']], function () {
    ...
    // Route::get('candidate-details/{uniqueId}/{code?}',
    ...
    Route::post('payment-candidate-stripe',[SubscriptionController::class,'paymentCandidateStripe'])->name('payment.candidate.stripe');
    Route::get('payment-candidate-success/{id}',[SubscriptionController::class,'paymentCandidateSuccess'])->name('payment.candidate.success');
});
...
Route::group([
    'middleware' => ['auth', 'role:Candidate', 'xss', 'verified.user','verify.candidate'], 'prefix' => 'candidate',
    ...
    function () {
        ...
        Route::get('/profile', [Candidates\CandidateController::class, 'editProfile'])->name('candidate.profile')->withoutMiddleware(['verify.candidate']);
        Route::put('update-profile', [Candidates\CandidateController::class, 'updateProfile'])->name('candidate-profile.update')->withoutMiddleware(['verify.candidate']);

        Route::get('edit-profile', [Candidates\CandidateController::class, 'editCandidateProfile'])->name('candidate.edit.profile')->withoutMiddleware(['verify.candidate']);
        Route::post('edit-change-password', [Candidates\CandidateController::class, 'changePassword'])->name('candidate.change-password')->withoutMiddleware(['verify.candidate']);
        Route::post('edit-profile-update', [Candidates\CandidateController::class, 'profileUpdate'])->name('candidate.update.profile')->withoutMiddleware(['verify.candidate']);;

        Route::post('/resumes', [Candidates\CandidateController::class, 'uploadResume'])->name('candidate.resumes')->withoutMiddleware(['verify.candidate']);
        Route::get('/media/{media?}', [CandidateController::class, 'downloadResume'])->name('download.resume')->withoutMiddleware(['verify.candidate']);
        Route::delete('/resumes/{media}', [Candidates\CandidateController::class, 'deletedResume'])->name('download.destroy')->withoutMiddleware(['verify.candidate']);
